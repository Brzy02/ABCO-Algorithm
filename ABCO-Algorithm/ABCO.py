...
def BCO(pop_s,iter,step_s, step_exp, step_explt, step_tum, dim, lb, ub, threshold, s, k, weight_mode, variable,val1,val2, unchangedthreshold):
    ...
    def reproduction()->None:
        ...
        BCO.actualBest= fitness_func2d(val1, val2,variable)if dimensions ==2 else fitness_func1d(val1,variable) # 8.05502, 9.66459 (holders)compute the actual best of function you are testing# 8.0
        
        sol= sorted_index[:1]
        
        BCO.bestsolution= pcost_n[sol]
        BCO.bestbacteria= pbest[sol] 
        BCO.error = BCO.bestsolution - BCO.actualBest     
    ...
    BCO.final_time = (end-start)
    print("final:",BCO.bestsolution,' at ',BCO.bestbacteria,'Actual best: ',BCO.actualBest,'error:', BCO.error)
